...
int main(int argc, char* argv[])
{
	...
	IrrlichtDevice* device;
	#ifdef MACOSX 
	device = createDevice(driverType, core::dimension2d<s32>(640, 480), 16, false, false, false, &keyboardReceiver);
	#else 
	...
	//ISceneNode* node = smgr->addMeshSceneNode(smgr->getMesh("model/EXAMPLE_1/women.x"));
