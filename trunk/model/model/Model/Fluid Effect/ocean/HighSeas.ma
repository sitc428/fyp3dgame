...
//Name: HighSeas.ma
//Last modified: Thu, Jan 09, 2003 12:00:10 PM
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr ".smpm" 0;
	setAttr ".rl" no;
createNode transform -n "HighSeasCam";
	setAttr ".v" no;
...
createNode camera -n "HighSeasCamShape" -p "HighSeasCam";
	setAttr -k off ".v" no;
