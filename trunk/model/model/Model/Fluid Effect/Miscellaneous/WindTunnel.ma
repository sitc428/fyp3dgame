...
//Name: WindTunnel.ma
//Last modified: Tue, Jul 23, 2002 03:13:28 PM
requires maya "4.5";
...
createNode fluidShape -n "windTunnelShape" -p "windTunnel";
	...
	setAttr ".dsc" 1;
	setAttr ".dsb" 0;
	setAttr ".fri" 0.087379999458789825;
	setAttr ".tgr" 6;
	...
	setAttr ".nts" -type "string" (
		...
		"This node simulates wind flowing through a shallow tunnel. Smoke tracers allow one to see the flow. Open the extra attributes section above to see custom wind tunnel attributes. Wind speed controls the velocity at the minX boundary and tracers is the number of smoke trails. These added attributes are used in an expression that uses setFluidAttr calls to set the boundary velocity(wind speed) and density( tracers ).\n"
		...
		+ "// Error: line: No objet matches: windTunnelShape\n\n"
...
createNode transform -n "WindTunnelCam";
	setAttr ".t" -type "double3" -0.26736799694529079 3.6673964501964984 29.585050860497603 ;
	setAttr ".r" -type "double3" 0.86164727039763822 -0.60000000000000098 -7.7654518624444925e-19 ;
createNode camera -n "WindTunnelCamShape" -p "WindTunnelCam";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 29.786732876228609;
