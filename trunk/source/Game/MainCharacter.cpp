	...
	_money(1000)
{
	...
	Item* weapon1 = new WeaponItem(world, WEAPONITEM1, "Sword", 10, "Sword with 10 Physical Attack point", text, "media/model/sword1.x");
	text = driver.getTexture("media/image/sword_image.png");
	Item* weapon2 = new WeaponItem(world, WEAPONITEM1, "Power Sword", 20, "Sword with 20 Physical Attack point", text, "media/model/sword.x");
