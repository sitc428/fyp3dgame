...
void ParticleSystemEngine::CreateBoxEmitter(irr::core::vector3df _direction,
									   irr::u32 _minParticlesPerSecond, irr::u32 _maxParticlesPerSecond, irr::u32 _lifeTimeMin,
									   irr::u32 _lifeTimeMax, irr::video::ITexture* _texture){
...
void ParticleSystemEngine::CreateMeshEmitter(irr::scene::IMesh * mesh, irr::core::vector3df _direction,
					   irr::u32 _minParticlesPerSecond, irr::u32 _maxParticlesPerSecond, irr::u32 _lifeTimeMin,
					   irr::u32 _lifeTimeMax, irr::video::ITexture* _texture){
