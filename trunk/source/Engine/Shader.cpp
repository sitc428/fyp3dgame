...
irr::s32 SHADER_MATERIAL_BASE = irr::video::EMT_SOLID;
irr::s32 SHADER_MATERIAL_STANDARD = irr::video::EMT_SOLID;
irr::s32 SHADER_MATERIAL_ANOTHER_EXAMPLE = irr::video::EMT_SOLID;
