...
//Name: NormalSea.ma
//Last modified: Fri, Jan 10, 2003 03:31:48 PM
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr -s 6 ".opa[0:5]"  0 0 1 0.61428571 0.81999999 
		...
		0.83999997 1;
	setAttr ".opi" 2;
	setAttr ".t" -type "float3" 0.88627452 0.88627452 0.88627452 ;
	setAttr -s 4 ".i";
	setAttr ".i[0].ip" 0.60000002384185791;
	setAttr ".i[0].ic" -type "float3" 0.53999996 0.95001334 1 ;
	setAttr ".i[0].ii" 1;
	setAttr ".i[1].ip" 0;
	setAttr ".i[1].ic" -type "float3" 0.053872012 0.32311535 0.59200001 ;
	setAttr ".i[1].ii" 1;
	setAttr ".i[2].ip" 0.22857142984867096;
	setAttr ".i[2].ic" -type "float3" 0.13072599 0.52487564 0.80199999 ;
	setAttr ".i[2].ii" 1;
	setAttr ".i[3].ip" 0.4285714328289032;
	setAttr ".i[3].ic" -type "float3" 0.29409701 0.66944098 0.88454199 ;
	setAttr ".i[3].ii" 1;
	setAttr ".ili" 2;
	...
	setAttr ".smpm" 0;
	setAttr ".rl" no;
createNode transform -n "NormalSeaCam";
	setAttr ".v" no;
...
createNode camera -n "NormalSeaCamShape" -p "NormalSeaCam";
	setAttr -k off ".v" no;
...
createNode oceanShader -n "oceanShader1";
	...
	setAttr ".env[1].envc" -type "float3" 0.47106403 0.74746382 0.80800003 ;
	setAttr ".env[1].envi" 2;
	setAttr ".env[2].envp" 0.70714282989501953;
	setAttr ".env[2].envc" -type "float3" 0.37300003 0.68670899 1 ;
	setAttr ".env[2].envi" 2;
	setAttr ".env[3].envp" 0.97857099771499634;
	setAttr ".env[3].envc" -type "float3" 0.083054982 0.29591498 0.73500001 ;
	...
	setAttr ".wd" 0.33009999990463257;
	setAttr ".nf" 6;
	setAttr ".wlx" 34.048000335693359;
	setAttr -s 4 ".wh";
	setAttr ".wh[0:2]" 0 0.059999998658895493 1 0.55000001192092896 
		0.039999999105930328 1 1 0.05000000074505806 1;
	setAttr ".wh[4].whp" 0.16428571939468384;
	setAttr ".wh[4].whfv" 0.090000003576278687;
	setAttr ".wh[4].whi" 1;
	setAttr -s 4 ".wtb[3:6]"  0.30000001 1 1 0.63571429 0 
		1 0.1 1 1 0 0.74000001 1;
	setAttr -s 5 ".wp[0:4]"  0 0.74000001 1 1 0.25999999 1 
		0.49285713 0.22 1 0.15000001 0.83999997 1 0.34285715 0.81999999 1;
	setAttr ".tsh" 0.28158000111579895;
	setAttr ".fc" -type "float3" 1.5 1.5 1.5 ;
	setAttr ".fmt" 0;
	setAttr ".d" -0.13656514883041382;
	setAttr ".bbl" 0.60000002384185791;
