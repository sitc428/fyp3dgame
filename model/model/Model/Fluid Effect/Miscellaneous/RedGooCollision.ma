...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "mlRoto1";
	setAttr -l on ".t";
	setAttr -l on ".r";
	setAttr -l on ".s";
createNode mlRoto -n "mlRotoShape1" -p "mlRoto1";
	setAttr -k off ".v";
	setAttr ".tm" 1;
...
createNode mlRotoCache -n "mlRotoCache1";
...
connectAttr "mlRotoCache1.cs" "mlRotoShape1.cs";
connectAttr "mlRotoCache1.fc" "mlRotoShape1.fc";
...
connectAttr "mlRotoShape1.fs" "mlRotoCache1.fs" -na;
