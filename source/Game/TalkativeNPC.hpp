...
{
public:
	TalkativeNPC( GameWorld& gameWorld, irr::core::array<irr::c8*>&, const irr::c8*, irr::f32, const irr::core::vector3df, const irr::core::vector3df, const irr::core::vector3df);
...
private:
	GameWorld& world;
	irr::core::array<irr::c8*> _dialogs;
